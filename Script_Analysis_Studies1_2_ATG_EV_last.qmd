---
title: "Moral Anger and Disgust: Recipient vs. Initiator Focus in Moral Transgressions"
subtitle: "Eva Vives, Astrid Thébault Guiochon, Bastien Trémolière, Agnès Falco, Hakim Djeriouat </br><i>Study of Cognitive Mechanisms (EMC) Laboratory</i>"
authors: 
  - name: Astrid Thébault Guiochon
    ...
    affiliations:
      - ref: emc
  - name: Eva Vives
    email: eva.vives@ugent.be
    orcid: 0000-0002-8477-848X
    url: https://evavives.github.io
affiliations:
  - id: emc
...
```{r}
#| label: setup-dl
#| code-summary: Downloading packages
#| code-fold: true
#| output: false 
...
```{r s1-exp4-rating-lmer, results = 'hide'}
...
```{r s2-exp2-rating-lmer, results = 'hide'}
